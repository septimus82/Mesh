...
def test_particles_sprite_config() -> None:
    window = _StubWindow()
    entity = _StubEntity()
    ...
    assert particle.sprite_path == "packs/core/fx/spark.png"
    assert appearance_key(particle) == ("sprite", "packs/core/fx/spark.png", None)
