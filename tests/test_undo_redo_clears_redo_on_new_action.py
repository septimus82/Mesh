...
def test_undo_redo_clears_redo_on_new_action(capsys) -> None:
    ...
    try:
        ...
        assert input_capture.handle_mouse_press(controller, 17.0, 1.0, arcade.MOUSE_BUTTON_LEFT, 0) is True
        assert input_capture.handle_mouse_release(controller, 17.0, 1.0, arcade.MOUSE_BUTTON_LEFT, 0) is True
