...
INSPECTOR_BG_COLOR = EDITOR_THEME.chrome_bg
INSPECTOR_SECTION_HEADER_BG = EDITOR_THEME.inspector_bg
INSPECTOR_SECTION_HEADER_TEXT = EDITOR_THEME.inspector_text
INSPECTOR_FIELD_LABEL_COLOR = EDITOR_THEME.inspector_text_soft
INSPECTOR_FIELD_VALUE_COLOR = EDITOR_THEME.text_primary
INSPECTOR_CURSOR_BG = EDITOR_THEME.inspector_selected
INSPECTOR_EDITABLE_COLOR = EDITOR_THEME.inspector_accent
INSPECTOR_READONLY_COLOR = EDITOR_THEME.inspector_dim
INSPECTOR_TEXT_EDIT_BG = EDITOR_THEME.inspector_border
