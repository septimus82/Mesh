...
class EditorProjectExplorerActionsController:
    ...
    def push_recent(self, kind: str, rel_path: str, label: str) -> None:
        from .project_explorer_model import ProjectExplorerRecentItem  # noqa: PLC0415
    ...
    def reveal_in_explorer(self, target_path: str) -> bool:
        ...
        from .project_explorer_model import PROJECT_LINE_HEIGHT  # noqa: PLC0415
    ...
    def reveal_current_in_explorer(self) -> bool:
        ...
        from .project_explorer_reveal_model import choose_reveal_target  # noqa: PLC0415
    ...
    def try_copy_to_os_clipboard(self, text: str) -> None:
        ...
        try:
            pyperclip_module = __import__("pyperclip")
