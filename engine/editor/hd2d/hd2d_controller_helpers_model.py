...
def compute_clipboard_patch_from_entity(entity_dict: dict[str, Any]) -> dict[str, Any]:
    ...
    """
    from .hd2d_entity_overrides_model import extract_override_patch  # noqa: PLC0415
...
def compute_next_batch_radius(current: int, delta: int) -> int:
    ...
    """
    from .hd2d_batch_radius_model import nudge_batch_radius  # noqa: PLC0415
...
def get_batch_radius_default() -> int:
    ...
    """
    from .hd2d_batch_radius_model import HD2D_BATCH_RADIUS_DEFAULT  # noqa: PLC0415
...
def count_clipboard_patch_fields(patch: dict[str, Any]) -> int:
    ...
    """
    from .hd2d_entity_overrides_model import count_patch_fields  # noqa: PLC0415
...
def format_batch_radius_display(radius: int) -> str:
    ...
    """
    from .hd2d_batch_radius_model import format_batch_radius_label  # noqa: PLC0415
