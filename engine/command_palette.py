...
DEFAULT_COMMAND_DEFS: tuple[_CommandDef, ...] = (
    ...
    {
        "id": "selection.remove_tag",
        "title": "Selection: Remove Tag...",
        "section": "Selection",
        "keywords": ("selection", "tag", "remove"),
        "is_enabled": "enabled_selection_has_non_player",
        "prompt": {"kind": "text", "placeholder": "tag", "default_value_fn": "default_empty"},
        "action": "action_props_remove_tag",
        "hotkey_hint": None,
    },
    {
        "id": "selection.toggle_tag",
        "title": "Selection: Toggle Tag...",
        "section": "Selection",
        "keywords": ("selection", "tag", "toggle"),
        "is_enabled": "enabled_selection_has_non_player",
        "prompt": {"kind": "text", "placeholder": "tag", "default_value_fn": "default_empty"},
        "action": "action_props_toggle_tag",
        "hotkey_hint": None,
    },
    {
        "id": "selection.batch_rename",
        "title": "Selection: Batch Rename...",
        "section": "Selection",
        "keywords": ("selection", "rename", "batch", "prefix", "suffix"),
        "is_enabled": "enabled_selection_has_non_player",
        "prompt": {"kind": "text", "placeholder": "prefix=X|suffix=Y", "default_value_fn": "default_empty"},
        "action": "action_batch_rename",
        "hotkey_hint": None,
    },
    {
        "id": "selection.set_names",
        "title": "Selection: Set Names (numbered)...",
        "section": "Selection",
        "keywords": ("selection", "name", "names", "number", "rename", "set"),
        "is_enabled": "enabled_selection_has_non_player",
        "prompt": {"kind": "text", "placeholder": "NPC or base=NPC|start=1|width=3", "default_value_fn": "default_empty"},
    ...
    },
    {
        ...
        "section": "Selection",
        "keywords": ("selection", "align", "left", "center", "right", "top", "middle", "bottom"),
        "is_enabled": "enabled_selection_has_non_player",
        "prompt": {"kind": "text", "placeholder": "left / center / right / top / middle / bottom", "default_value_fn": "default_empty"},
        "action": "action_align_selection",
        "hotkey_hint": None,
    },
    {
        "id": "selection.distribute",
        "title": "Selection: Distribute\u2026",
        "section": "Selection",
        "keywords": ("selection", "distribute", "gap", "center", "space", "even"),
        "is_enabled": "enabled_selection_has_non_player",
        "prompt": {"kind": "text", "placeholder": "distribute_x_gap / distribute_y_center / axis=x|mode=gap", "default_value_fn": "default_empty"},
        "action": "action_distribute_selection",
        "hotkey_hint": None,
    },
    {
        "id": "selection.snap_to_grid",
        "title": "Selection: Snap to Grid\u2026",
        "section": "Selection",
        "keywords": ("selection", "snap", "grid", "nearest", "floor", "ceil"),
        "is_enabled": "enabled_selection_has_non_player",
        "prompt": {"kind": "text", "placeholder": "step=16|axes=xy|mode=nearest  or  just 16", "default_value_fn": "default_empty"},
        "action": "action_snap_to_grid",
        "hotkey_hint": None,
    },
    {
        "id": "selection.nudge",
        ...
        "section": "Selection",
        "keywords": ("selection", "nudge", "move", "left", "right", "up", "down"),
        "is_enabled": "enabled_selection_has_non_player",
        "prompt": {"kind": "text", "placeholder": "left / right x3 step=16 / dx=1|dy=0|count=3|step=16", "default_value_fn": "default_empty"},
        "action": "action_nudge_selection",
        "hotkey_hint": None,
    },
    {
        "id": "selection.rotate",
        "title": "Selection: Rotate\u2026",
        "section": "Selection",
        "keywords": ("selection", "rotate", "rotation", "cw", "ccw", "angle"),
        "is_enabled": "enabled_selection_has_non_player",
        "prompt": {"kind": "text", "placeholder": "cw / ccw / 180 / deg=90|about=group", "default_value_fn": "default_empty"},
        "action": "action_rotate_selection",
        "hotkey_hint": None,
    },
    {
        "id": "selection.mirror",
        "title": "Selection: Mirror / Flip\u2026",
        "section": "Selection",
        "keywords": ("selection", "mirror", "flip", "reflect", "horizontal", "vertical"),
        "is_enabled": "enabled_selection_has_non_player",
        "prompt": {"kind": "text", "placeholder": "x / y / x primary / y no-rot / axis=x|about=group|rot=1", "default_value_fn": "default_empty"},
        "action": "action_mirror_selection",
        "hotkey_hint": None,
    },
    {
        "id": "selection.group",
        ...
        "section": "Selection",
        "keywords": ("selection", "group", "container", "parent"),
        "is_enabled": "enabled_selection_has_non_player",
        "prompt": {"kind": "text", "placeholder": "Group / MyGroup primary / base=Group|about=primary", "default_value_fn": "default_empty"},
        "action": "action_group_selection",
        "hotkey_hint": None,
    },
    {
        "id": "selection.ungroup",
        "title": "Selection: Ungroup",
        "section": "Selection",
        "keywords": ("selection", "ungroup", "dissolve", "flatten"),
        "is_enabled": "enabled_selection_has_non_player",
        "prompt": None,
        "action": "action_ungroup_selection",
        "hotkey_hint": None,
    },
    {
        "id": "selection.duplicate_to_grid",
        "title": "Selection: Duplicate to Grid\u2026",
        "section": "Selection",
        "keywords": ("selection", "duplicate", "grid", "copy", "array", "tile"),
        "is_enabled": "enabled_selection_has_non_player",
        "prompt": {"kind": "text", "placeholder": "3x4 dx=32 dy=32 / rows=3|cols=4|dx=32|dy=32|include=1|name=numbered", "default_value_fn": "default_empty"},
        "action": "action_duplicate_to_grid",
        "hotkey_hint": None,
    },
    {
        "id": "selection.duplicate_along_path",
        "title": "Selection: Duplicate Along Path\u2026",
        "section": "Selection",
        "keywords": ("selection", "duplicate", "path", "copy", "line", "segment", "along"),
        "is_enabled": "enabled_selection_has_non_player",
        "prompt": {
            "kind": "text",
            "placeholder": "0,0 128,0 5 / from=0,0|to=128,0|count=5|include=1|name=numbered|orient=1",
            "default_value_fn": "default_empty",
        },
        "action": "action_duplicate_along_path",
        "hotkey_hint": None,
    },
    {
        "id": "selection.scatter",
        "title": "Selection: Scatter\u2026",
        "section": "Selection",
        "keywords": ("selection", "scatter", "random", "duplicate", "distribute", "seed"),
        "is_enabled": "enabled_selection_has_non_player",
        "prompt": {
            "kind": "text",
            "placeholder": "n=10|shape=circle|radius=128|center=group|seed=123|rot=15|snap=16|include=1|name=numbered  /  10 seed=123 radius=128",
            "default_value_fn": "default_empty",
        },
        "action": "action_scatter_selection",
        "hotkey_hint": None,
    },
    {
    ...
    },
    {
        ...
        "prompts": (
            {"kind": "pick", "placeholder": "anchor", "default_value_fn": "default_cursor", "options_provider": "options_macro_anchor", "field": "anchor"},
            {
                ...
                "default_value_fn": "default_empty",
                "options_provider": "options_all_scenes",
                "field": "target_scene",
            },
        ...
        "prompts": (
            {
                ...
                "default_value_fn": "default_empty",
                "options_provider": "options_dialogue_speakers",
                "field": "speaker_id",
            },
