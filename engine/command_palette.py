...
DEFAULT_COMMAND_DEFS: tuple[_CommandDef, ...] = (
    ...
    },
    {
        ...
        "is_enabled": "enabled_selection_has_non_player",
        "prompt": {"kind": "text", "placeholder": "0,0 128,0 5 / from=0,0|to=128,0|count=5|include=1|name=numbered|orient=1", "default_value_fn": "default_empty"},
    ...
    },
    {
        ...
        "is_enabled": "enabled_selection_has_non_player",
        "prompt": {"kind": "text", "placeholder": "n=10|shape=circle|radius=128|center=group|seed=123|rot=15|snap=16|include=1|name=numbered  /  10 seed=123 radius=128", "default_value_fn": "default_empty"},
